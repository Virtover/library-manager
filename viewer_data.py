...
class ViewerDataManager:
    ...
    def get_all_records(self):
        ...
        for row in self.df.values:
            # Convert None/NaN values to empty strings for consistency
            sanitized = tuple('' if (val is None or (isinstance(val, float) and val != val)) else str(val) for val in row)
    ...
    def filter_records(self, filters):
        ...
        # Fill NaN values with empty strings for filtering
